...
def define_constants():
    ...
    return threshold_number, time_gap, packing_density_threshold
...
def search(akr_df):
    ...
    # Define constants
    threshold_number, time_gap, packing_density_threshold = define_constants()
    ...
    burst_stimes, burst_stimes_2 = find_starts_and_ends(datetimes,
                                                        n_filled,
                                                        above_threshold_n)
    ...
    return burst_stimes, burst_stimes_2
